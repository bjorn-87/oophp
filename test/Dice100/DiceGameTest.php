...
class DiceGameTest extends TestCase
{
    ...
    {
        $game = new DiceGame();
        $this->assertInstanceOf("\Bjos\Dice100\DiceGame", $game);
     ...
     * properties. Use no arguments.
     */
    public function testComputerRollGotOnes()
    {
        $game = new DiceGame("hej", 1, 2, 0, 1);
        $this->assertInstanceOf("\Bjos\Dice100\DiceGame", $game);
     ...
     * properties. Use no arguments.
     */
    public function testComputerStopOnWinScore()
    {
        $game = new DiceGame("hej", 1, 2, 0, 0);
        $this->assertInstanceOf("\Bjos\Dice100\DiceGame", $game);

        $game->nextPlayer();
        $game->computerRoll(90, 0, 10);
